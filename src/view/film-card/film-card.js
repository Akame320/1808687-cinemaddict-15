export const createFilmCart = (data) => {

  const {description} = data;

  const getFormatDescription = () => {
    return description >= 140 ? description.join('') : description.join('').substr(0, 140) + '&hellip;';
  }
  ...
  return `<article class="film-card">
    ...
    <p class="film-card__description">${getFormatDescription()}</p>
