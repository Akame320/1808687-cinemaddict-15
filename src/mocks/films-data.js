...
const getRandomElemsFromArray = (array) => {
  return array.filter(() => getRandomInt(0, 1));
}

const getRandomDuration = () => {
  return `${getRandomInt(1, 2)}h ${getRandomInt(0, 59)}m`
}

const setIdForFilm = () => {
  return `${getRandomInt(0, 99999999)}${getRandomInt(0, 99999999)}${getRandomInt(0, 99999999)}${getRandomInt(0, 99999999)}`
}
...
const createComment = () => {
  return {
    data: new Array(4).fill(null).map(() => getRandomComments())
  }
}

export {createFilm, createComment, setIdForFilm};
